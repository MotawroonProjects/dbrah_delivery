package com.app.dbrah_delivery.notifications;
...
import com.app.dbrah_delivery.model.ClientModel;
import com.app.dbrah_delivery.model.MessageModel;
import com.app.dbrah_delivery.model.NotiFire;
import com.app.dbrah_delivery.model.ProviderModel;
...
import com.app.dbrah_delivery.share.App;
    ...
    private void manageNotification(Map<String, String> map) {
        ...
        if (notification_type.equals("chat")) {
            ...
            if (getRoomId() != null && (order_id.equals(getRoomId().getOrder_id())
                ...
                if (className.equals("com.app.dbrah_delivery.uis.activity_chat.ChatActivity")) {
