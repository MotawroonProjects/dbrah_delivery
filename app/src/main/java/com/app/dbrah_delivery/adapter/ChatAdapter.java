...
import com.app.dbrah_delivery.databinding.ChatImageLeftRowBinding;
import com.app.dbrah_delivery.databinding.ChatImageRightRowBinding;
import com.app.dbrah_delivery.databinding.ChatMessageLeftRowBinding;
import com.app.dbrah_delivery.databinding.ChatMessageRightRowBinding;
import com.app.dbrah_delivery.model.MessageModel;
import com.app.dbrah_delivery.uis.activity_chat.ChatActivity;
...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public int getItemViewType(int position) {
        ...
        if (messageModel.getType().equals("text")) {
            ...
            if (messageModel.getFrom_type().equals("representative")) {
